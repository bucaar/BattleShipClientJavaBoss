...
public class BattleShipPlayerTest {
    ...
    private boolean shipOutOfBounds = false;
    
    private int[][][] myShipCoords = new int[][][]{
...
//            {{9,6},{9,7}},
    ...
    public void testGetShipLayout_shipsPlacedInBounds()
    {
        getPlayerBoard();
        if(shipOutOfBounds){
            fail("This test fails if at least one ship was placed out of bounds");
        }
    }
    ...
    public void testGetShotLocation(){
        ...
        System.out.println("Begin testShotLocation");
